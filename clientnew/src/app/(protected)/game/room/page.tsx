...
import {initYearForPlayer} from "@/src/store/slices/gameSlice";
...
function RoomPage() {
  ...
  const { spotifyPlaylist, randomSong, loading, generateRandomSong } = useGetSpotifyPlaylist('6tAdMSXECJTIWWP4GVpn83');
